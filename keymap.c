...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK_DH] = LAYOUT_5x6_5(
        ...
        MS_CAPS, KC_Z  , KC_X  , KC_C  , KC_D  , KC_V  ,                         KC_K   , KC_H  ,KC_COMM, TD_DOT,KC_SLSH,ARROW_R,
              KC_BSLASH,C_CDILA,        MS_CAPS,NAV_TAB, COMPOSE,        KC_DOWN, KC_UP , SYM_ENT,       KC_RALT, KC_GRV,
                                                 KC_SPC, OS_LSFT,            SH_OS,KC_BSPC
  ),
  ...
  [_NAV] = LAYOUT_5x6_5(
        ...
        _______, YICODE,C(KC_A),C(KC_C),C(KC_V),_______,                          _______,KC_PSCR,KC_LCBR,KC_RCBR,KC_INS ,KC_VOLD,
                _______,_______,        _______,_______,_______,          _______,_______,_______,        KC_BRID,KC_BRIU,
                                                _______,_______,          ADJUST ,ADJUST
  ),
    ...
    [_PLOVER] = LAYOUT_5x6_5(
        KC_ESC , KC_1  , KC_2  , KC_3  , KC_4  , KC_5  ,                        KC_6   ,KC_7  , KC_8  , KC_9  , KC_0  ,KC_BSPC,
        KC_TAB , KC_Q  , KC_W  , KC_E  , KC_R  , KC_T  ,                        KC_Y   ,KC_U  , KC_I  , KC_O  , KC_P  ,KC_MINS,
        KC_LSFT, KC_A  , KC_S  , KC_D  , KC_F  , KC_G  ,                        KC_H   ,KC_J  , KC_K  , KC_L  ,KC_SCLN,KC_QUOT,
        KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                        KC_N   ,KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
                 KC_LBRC,KC_RBRC,        KC_B  , KC_C  , KC_TAB,         _______,KC_BSPC, KC_DEL,       KC_PLUS, KC_EQL,
                                                 KC_N  , KC_SPC,         PLOVER,KC_LGUI, KC_LALT
